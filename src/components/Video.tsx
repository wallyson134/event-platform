        ...
        <div className="p-8 max-w-[1100px] mx-auto">
              ...
              <div className="flex-1 ">
               ...
               <div className="flex items-center gap-4 mt-6">
                  <img
                    ...
                    alt="" />
                  <div className="learning-relaxed">
           ...
           <div className="gap-8 mt-5 grid grid-cols-2">
             <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                <div className="bg-green-700 h-full p-6 felx items-center ">
                ...
                <div className="py-6 leading-relaxed flex items-center">
                    <CaretRight size={24}/>
                </div>
             </a>
             <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                ...
                <div className="py-6 leading-relaxed">
                    ...
                    <p className="text-sm text-gray-200 mt-2">
                        Baixe os Walpapers exclusivos do Ignite Lab e personalize sua maquina
                    </p>
                </div>
